<!-- resources/js/Components/pmb/yayasan/steps/StepYayasanAccount.vue -->
<script setup>
...
const passwordStrength = computed(() => {
  ...
  if (!p) {
    return { label: ' ', percent: 0, barClass: '', textClass: '' }
  }
  ...
  <div class="space-y-4">
    ...
    <div class="flex items-center gap-2">
      ...
      <div>
        ...
        >
          Akun PMB & Kontak Beasiswa Yayasan
        </h2>
        <p class="text-[11px] text-slate-500 dark:text-slate-400">
          Akun ini dipakai untuk login portal PMB dan menerima informasi beasiswa.
        </p>
      </div>
    </div>
    ...
    <div class="grid md:grid-cols-2 gap-4 md:gap-6">
      ...
      <!-- Nomor WhatsApp (seperti StepContactAccount) -->
      <div class="md:col-span-2">
        <label
          class="block text-xs font-medium text-slate-700 dark:text-slate-200 mb-1"
        >
          Nomor WhatsApp (untuk OTP & informasi) <span class="text-red-500">*</span>
        </label>
        <input
        ...
        <p class="mt-1 text-[10px] text-slate-500 dark:text-slate-400">
          Pastikan nomor aktif dan terhubung ke WhatsApp. OTP dan informasi penting
    ...
    <p class="text-[11px] text-slate-500 dark:text-slate-400">
      Kata sandi digunakan untuk login ke portal PMB dan mengecek status Beasiswa
      Yayasan. Jangan membagikan kata sandi ke orang lain.
    </p>
  </div>
</template>
