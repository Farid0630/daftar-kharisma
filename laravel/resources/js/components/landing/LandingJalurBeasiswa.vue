...
const jalurItems = [
  ...
  {
    key: 'kip',
    label: 'Jalur KIP Kuliah',
    badge: 'KIP',
    tag: 'Untuk siswa berprestasi',
    accent: 'Tepat bagi yang membutuhkan dukugan pembiayaan kuliah.',
    colorClass: 'bg-amber-500/10 text-amber-800 dark:text-amber-100',
    icon: BanknotesIcon,
    highlight: true,
    desc: 'Diperuntukkan bagi siswa berprestasi yang mengalami kendala ekonomi sesuai ketentuan resmi KIP Kuliah.',
    bullets: [
      'Siswa lulus tahun 2026, 2025 dan 2024.',
      'Berpeluang mendapat biaya hidup.',
      'Mendaftarkan diri melalui KHARISMA College dan website KIP Kuliah.',
    ],
    registerUrl: '/pmb/register/kip',
    buttonText: 'Daftar Jalur KIP Kuliah',
  },
  {
    key: 'yayasan',
